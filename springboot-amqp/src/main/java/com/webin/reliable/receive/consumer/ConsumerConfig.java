package com.webin.reliable.receive.consumer;
...
public class ConsumerConfig {
    ...
    @Bean
    public Binding binding(@Qualifier("myqueue") Queue queue, @Qualifier("myexchange") DirectExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("my.test.reliable");
    }
